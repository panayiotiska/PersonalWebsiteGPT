...
layout:     post
title:      "Who Am I"
subtitle:   "Panayiotis Kattides, Data Scientist from Cyprus"
date:       2019-10-04
author:     "Panayiotis"
image:      "https://img.zhaohuabing.com/post-bg-2015.jpg"
---

# [Panayiotis Kattides](https://www.linkedin.com/in/panayiotis-kattides/)

is a Data Scientist and Data Engineer with experience in Python, SQL, Airflow, MongoDB, Snowflake, Machine Learning, Fraud Detection, NLP, Time Series Forecasting, Statistics, Big Data and AWS deployment. Worked on various projects in Fintech companies and consulting, including data processing, machine learning, prediction models, fraud detection, data engineering and big data. Panayiotis holds an MSc in Data Science and Analytics from Cardiff University and a BSc in Applied Informatics from the University of Macedonia.

As a data engineer at XM, a fintech company, I maintained a MongoDB database and optimized insertion scripts for large volumes of data from various SQL databases. I also created single views by combining data from multiple collections, applied feature engineering, and built a pipeline from an ElasticSearch database to stream log data of the company's website traffic to the data science Mongo database. I introduced Airflow as a new tool to the team and built an anomaly detection tool using time-series analysis and statistical models.

As a data scientist at KPMG, a consulting firm, I built end-to-end solutions for the largest organizations in Cyprus and worldwide, successfully improving ROI, increasing revenue, and reducing costs. I built a Shiny application for supply chain, a multivariate time-series forecasting model for retail sales, and a demand forecasting model for shipping. I also optimized scheduling for employees of a healthcare organization, proposed better tactics for an NBA team, and optimized an industry's workflow.

I hold an MSc in Data Science and Analytics from Cardiff University, where I built forecasting models for a healthcare organization, applied statistical methodologies to discover insights for an NBA team, optimized an industry's workflow, and handled image pre-processing for an object detection task in a team project. I also hold a BSc in Applied Informatics from the University of Macedonia, where I attended 38 modules in total and received extremely positive feedback on my natural language processing-focused dissertation.

In my free time, I enjoy going to the gym, trading/investing, and reading.
